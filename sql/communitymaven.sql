...
CREATE TABLE `building`(     #创建管理楼房信息的数据表
...
CREATE TABLE `carcharge` (  #创建管理收费信息的数据表
    `id` int(10) NOT NULL AUTO_INCREMENT,   #主键,自增长的整数类型
...
CREATE TABLE `clockin` (    #创建用于记录业主的打卡信息的数据表
...
CREATE TABLE `clockinnew` ( #创建于记录业主的健康状况信息的数据表
  `id` int(11) NOT NULL AUTO_INCREMENT, #主键,自增长的整数类型
  `report_date` datetime DEFAULT NULL,#报告日期,日期时间类型
  `owner_id` int(11) DEFAULT NULL,  #业主ID,整数类型,最多11位数
  `type1` int(11) DEFAULT NULL COMMENT '是否为疑似病例如咳嗽,发热(0或1)',#是否为疑似病例,整数类型,最多11位数,值为0或1,0表示不是疑似病例,1表示是疑似病例
  `type2` int(11) DEFAULT NULL COMMENT '是否确诊为肺炎病例',#是否确诊为肺炎病例,整数类型,最多11位数,值为0或1,0表示未确诊为肺炎病例,1表示已确诊为肺炎病例
...
CREATE TABLE `complaint` (  #创建用于记录业主的投诉信息的数据表
  `id` int(11) NOT NULL AUTO_INCREMENT, #主键，自增长的整数类型
...
CREATE TABLE `complaint_type` ( #创建用于记录投诉类型的信息的数据表
  `id` int(10) NOT NULL AUTO_INCREMENT, #主键，自增长的整数类型
...
CREATE TABLE `house` (  #创建用于记录房间的信息的数据表
...
CREATE TABLE `notice` ( #创建用于记录公告的信息的信息表
  `id` int(11) NOT NULL AUTO_INCREMENT, #主键，自增长的整数类型
...
CREATE TABLE `owner` (  #创建用于记录业主的信息的数据表
  `id` int(5) NOT NULL AUTO_INCREMENT,  #主键，自增长的整数类型，最多5位数
...
CREATE TABLE `parking` (    #创建用于记录车位的信息的数据表
  `id` int(11) NOT NULL AUTO_INCREMENT, #主键，自增长的整数类型
...
CREATE TABLE `property_info` (  #创建用于记录物业费收费信息的数据表
  `id` int(11) NOT NULL AUTO_INCREMENT, #主键，自增长的整数类型
...
CREATE TABLE `property_type` ( #创建用于记录物业费类型信息的数据表
  `id` int(11) NOT NULL AUTO_INCREMENT,  #主键，自增长的整数类型
...
CREATE TABLE `records` (    #创建用于记录各种类型的记录信息的数据表
  `id` int(11) NOT NULL AUTO_INCREMENT, #主键，自增长的整数类型
...
CREATE TABLE `repair` ( #创建用于记录报修信息的数据表
  `id` int(11) NOT NULL AUTO_INCREMENT, #主键，自增长的整数类型
...
CREATE TABLE `repairtype` ( #创建用于记录报修类型信息的数据表
  `id` int(11) NOT NULL AUTO_INCREMENT, #主键，自增长的整数类型
...
CREATE TABLE `userinfo` (   #创建用于记录用户信息的数据表
  `id` int(11) NOT NULL AUTO_INCREMENT, #主键，自增长的整数类型
