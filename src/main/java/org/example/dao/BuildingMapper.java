...
public interface BuildingMapper {
    List<Building> queryBuildAll(@Param("numbers") String numbers); //通过传入的numbers参数进行查询，返回一个Building对象列表

    Building queryBuildById(@Param("buildId") Integer buildId); //通过传入的buildId参数进行查询，返回一个Building对象
}
